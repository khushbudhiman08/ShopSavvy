...
function App() {
  ...
  return (
    <div>
      <Navbar navStatus = {navStatus} cartCount = {cartCount} setSearchResult = {setSearchResult} searchResult = {searchResult}/>
      
      <Routes>
        <Route path='/' element = {<Mainpage shoeInfo = {shoeInfo} setShoeInfo = {setShoeInfo} />}></Route>
        <Route path='/men' element = {<Men  searchResult = {searchResult} shoeInfo = {shoeInfo} setShoeInfo = {setShoeInfo} title = "Men" menData = {MenData} womenData = {WomenData} setnavStatus = {setnavStatus}/>}></Route>
        <Route path='/women' element = {<Women  searchResult = {searchResult} shoeInfo = {shoeInfo} setShoeInfo = {setShoeInfo} title = "Women" womenData = {WomenData} menData = {MenData} setnavStatus={setnavStatus}/>}></Route>
        <Route path='/collection' element = {<Collection  shoeInfo = {shoeInfo} setShoeInfo = {setShoeInfo} title="Shop" womenData={WomenData} menData={MenData} setnavStatus={setnavStatus} searchResult = {searchResult}/>}></Route>
        <Route path='/lookbook' element = {<Lookbook/>}></Route>
        <Route path='/contact' element = {<Contact/>}></Route>
        <Route path='/buyshoe' element = {<ShoeBuyCard shoeInfo = {shoeInfo} setCartCount = {setCartCount} cartCount = {cartCount} cartItems = {cartItems} setCartItems = {setCartItems}/>}></Route>
        <Route path='/cart' element = {<Cart shoeInfo = {shoeInfo} cartCount = {cartCount} setCartCount = {setCartCount} cartItems = {cartItems} setCartItems = {setCartItems} setTotalOrderCost = {setTotalOrderCost}/>}></Route>
        <Route path = "/nomatch" element = {<NoItemsMatched searchResult = {searchResult}/>}></Route>
        <Route path = "/account" element = {loginStatus ? <Account mainUser = {mainUser} setLoginStatus = {setLoginStatus}/> : <Login setLoginStatus = {setLoginStatus} setMainUser = {setMainUser}/>}></Route>
        <Route path='/checkout' element={<Checkout setnavStatus = {setnavStatus} cartItems = {cartItems} totalOrderCost = {totalOrderCost} setFooterStatus = {setFooterStatus}/>}></Route>
        <Route path='/confirm' element = {<OrderConfirmation setCartItems = {setCartItems} setnavStatus = {setnavStatus} setFooterStatus = {setFooterStatus} setCartCount = {setCartCount}/>}></Route>
      </Routes>
      {footerStatus && <Footer/>}
    </div>
  );
